...
namespace DoctrineProxies\__CG__\Modules\Administrator\Entities;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Administrator extends \Modules\Administrator\Entities\Administrator implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'email', 'password', 'remember_token'];
        }
